...
def get_args_parser():
    ...
    parser.add_argument("--output", type=str, default='./output_result_scut',
    ...
    parser.add_argument("--mask_path", type=str, default="D:\\lg\\word_mask_scut",
                        help="mask_path")
    parser.add_argument("--label_path", type=str, default="D:\\lgdata_other\\test\\all_labels",
                        help="label path.")
