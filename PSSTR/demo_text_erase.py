...
if __name__ == '__main__':
    ...
    for path in tqdm(args.input, disable=not args.output):
        ...
        if args.promptable and args.erase_mode:
            ...
            # input_point = np.array([[274, 260],[389, 250]])  # for demo/FIS_1.jpg
            # input_point = np.array([[143, 229],[241, 215]])  # for demo/FIS_384.jpg
            ...
            # input_box = np.array([[194,68,250,99]]) # box for test/FIS_12.jpg '101'
            # input_box = np.array([[194,68,250,99],[186,137,242,160]]) # box for test/FIS_12.jpg '101'
            # input_box = np.array([[194,68,250,99],[186,137,242,160]]) # box for test/FIS_12.jpg '101'

            # input_mask = np.zeros((h, w)) 
            # input_mask[288:299, 255:289] = 255 # mask for FIS_1.jpg
            # input_mask[137:160, 186:242] = 255 # mask for FIS_12.jpg "san"
            # input_mask[224:266, 258:311] = 255 # mask for FIS_730.jpg "TRAFALCAR"
